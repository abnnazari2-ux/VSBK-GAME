          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-5">
              <div className="glass-panel p-5 gold-border rounded-xl">
                ...
                <div className="flex gap-3">
                  {FRAME_OPTIONS.map(f => (
                    <button key={f} onClick={() => setFrames(f)} className="flex-1 py-2.5 rounded-lg font-bold transition-all text-sm"
              ...
              <div className="glass-panel p-5 gold-border rounded-xl">
                ...
                <div className="flex gap-3">
                  {TIMER_OPTIONS.map(t => (
                    <button key={t} onClick={() => setTimer(t)} className="flex-1 py-2.5 rounded-lg font-bold transition-all text-sm"
              ...
              <div className="glass-panel p-5 gold-border rounded-xl">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {THEMES.map(t => (
                    <button key={t} onClick={() => setTheme(t)} className="py-2.5 rounded-lg font-medium transition-all text-sm"
              ...
              <div className="glass-panel p-5 gold-border rounded-xl">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      {(['public', 'private'] as const).map(p => (
                        <button key={p} onClick={() => setPrivacy(p)} className="px-4 py-1.5 rounded-lg text-sm font-medium capitalize transition-all"
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button onClick={() => setAllowSpectators(v => !v)} className="w-12 h-6 rounded-full transition-all relative"
            ...
            <div className="space-y-5">
              <div className="glass-panel p-5 gold-border rounded-xl">
                ...
                {[['Mode', 'Best of ' + frames], ['Timer', timer], ['Theme', theme], ['Privacy', privacy], ['Spectators', allowSpectators ? 'Allowed' : 'Disabled']].map(([k, v]) => (

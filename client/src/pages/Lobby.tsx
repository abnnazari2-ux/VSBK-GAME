          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <div className="glass-panel px-4 py-2 rounded-lg gold-border flex items-center gap-2">
                ...
                <span className="font-bold tracking-widest" style={{ color: 'var(--gold-primary)', fontFamily: 'Rajdhani' }}>
                  {currentRoom?.code ?? '----'}
                </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        {p ? (
                          <>
                            <div className="flex justify-center mb-3">
                              <PlayerAvatar name={p.name} rank={p.rank as any} size="lg" status="online" />
                            </div>
                          ...
                          <div className="py-8">
                            ...
                            <motion.div animate={{ opacity: [0.3, 1, 0.3] }} transition={{ repeat: Infinity, duration: 1.5 }}
                              className="w-2 h-2 rounded-full bg-yellow-400 mx-auto mt-3" />
                          </div>
                        )}
                      </motion.div>
                    );
            ...
            <div className="glass-panel gold-border rounded-xl flex flex-col" style={{ height: '420px' }}>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-3">
                ...
                {messages.length === 0 && (
                  <p className="text-center text-gray-600 text-sm mt-8">Say hello to your opponent!</p>
                )}
              </div>
